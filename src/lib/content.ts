...
export const content = {
  es: {
    ...
    guia: {
      ...
      placeSingular: "lugar",
      placePlural: "lugares",
      // Posiciones (x, y en % sobre mapa3d.webp, imagen de 1672×941 px) estimadas
      // visualmente sobre la ilustración. Son un punto de partida: ajusta los
      // valores mirando la sección "Descubre Cáceres" en el navegador hasta que
      // cada pin caiga exactamente sobre su edificio en la imagen.
      radarPoints: [
        {
          id: 1,
