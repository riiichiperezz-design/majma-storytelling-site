...
export const content = {
  es: {
    ...
    guia: {
      ...
      // Plantilla para una distancia ESTIMADA (no medida) — ver comentario
      // junto a WALK_METERS_PER_MIN en DiscoverCaceresMap.
      distanceApprox: "Aprox. {m} m",
      mapTapHint: "Toca o pasa el cursor sobre un punto del mapa",
      discoverLabel: "Descubre Cáceres",
      discoverSubtitle:
        "Desde Apartamentos Majma, recorre a pie los principales monumentos y rincones históricos de Cáceres.",
      closeCard: "Cerrar",
  ...
  en: {
    ...
    guia: {
      ...
      distanceApprox: "Approx. {m} m",
      mapTapHint: "Tap or hover a point on the map",
      discoverLabel: "Discover Cáceres",
      discoverSubtitle:
        "From Apartamentos Majma, explore Cáceres' main monuments and historic corners on foot.",
      closeCard: "Close",
      majmaPinLabel: "Apartamentos MAJMA",
      placeSingular: "place",
      placePlural: "places",
